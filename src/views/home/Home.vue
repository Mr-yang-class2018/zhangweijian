<template>
  <div id="home">
    <nav-bar class="home-nav-bar">
      <div slot="left" v-on:click="$store.commit('ROUTERTO','/category')">≡</div>
      <div slot="center">
    ...
    >
      ...
      <div style="background:#f6f6f6;">
        <img style="width:100%;" src="../../assets/img/djxy1.jpg" alt />
      </div>
      <div style="padding:0 10px 20px;height:230px;background:#f6f6f6;">
        <div style="height:100%;background:#fff;">
          <div style="height:107px;border-bottom:1px solid #f6f6f6;">
            <div style="width:170px;border-right:1px solid #f6f6f6;text-align:left;padding:5px 0 0 5px;line-height:20px;float:left;">
              <p style="background: linear-gradient(90deg, #45CAFF,#1471FB);color: transparent;webkit-background-clip: text;">经典童书</p>
              <p style="font-size:12px;">不容错过的好书</p>
              <img style="width:35%;margin:0 10px;" src="../../assets/img/djxy9.jpg" alt="">
              <img style="width:35%;" src="../../assets/img/djxy2.jpg" alt="">
            </div>
            <div style="width:170px;text-align:left;padding:5px 0 0 5px;line-height:20px;float:left;">
              <p style="background: linear-gradient(90deg, #45CAFF,#1471FB);color: transparent;webkit-background-clip: text;">多彩世界</p>
              <p style="font-size:12px;">助孩子认识多彩世界</p>
              <img style="width:35%;margin:0 10px;" src="../../assets/img/djxy3.jpg" alt="">
              <img style="width:35%;" src="../../assets/img/djxy4.jpg" alt="">
            </div>
          </div>
          <div>
            <div style="float:left;text-align:center;width:83px;padding:10px 0 0 5px;">
              <h4>流光溢彩</h4>
              <p style="color:#666771;font-size:12px;margin:5px 0;">原创设计</p>
              <img style="width:70%;" src="../../assets/img/djxy5.jpg" alt="">
            </div>
            <div style="float:left;text-align:center;width:83px;padding:10px 0 0 5px;">
              <h4>安全第一</h4>
              <p style="color:#666771;font-size:12px;margin:5px 0;">呵护安全</p>
              <img style="width:70%;" src="../../assets/img/djxy6.jpg" alt="">
            </div>
            <div style="float:left;text-align:center;width:83px;padding:10px 0 0 5px;">
              <h4>元气少年</h4>
              <p style="color:#666771;font-size:12px;margin:5px 0;">元气满满</p>
              <img style="width:70%;" src="../../assets/img/djxy7.jpg" alt="">
            </div>
            <div style="float:left;text-align:center;width:83px;padding:10px 0 0 5px;">
              <h4>棉麻夏装</h4>
              <p style="color:#666771;font-size:12px;margin:5px 0;">居家必选</p>
              <img style="width:70%;" src="../../assets/img/djxy8.jpg" alt="">
            </div>
          </div>
        </div>
      </div>
